								...
								<tbody>
									...
									while($d = mysqli_fetch_array($data)){
										...
										<tr>
											...
											<td>
											<?php 
											// Menghitung jumlah hari cuti dari tanggal mulai hingga akhir
											$start_date = new DateTime($d['cuti_dari']);
											$end_date = new DateTime($d['cuti_sampai']);
											$interval = $start_date->diff($end_date);
											// Tambahkan 1 hari untuk menghitung termasuk hari terakhir
