      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="#">Detail Cuti</a></li>              
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <div class="float-right">
                <a href="cuti_saya.php" class="btn btn-sm btn-warning"><i class="fa fa-minus"></i> Kembali</a>
