          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                <?php
                $karyawan_foto = isset($d['karyawan_foto']) ? $d['karyawan_foto'] : '';
                  ?>
              ...
              <ul class="list-group list-group-unbordered mb-3">
                <li class="list-group-item">
                  <b>Jabatan</b> <a class="float-right"><?php echo $d['karyawan_jabatan'] ?></a>
                </li>                              
              </ul>
              <ul class="list-group list-group-unbordered mb-3">
                <li class="list-group-item">
              ...
              <ul class="list-group list-group-unbordered mb-3">
                <li class="list-group-item">
                  <b>Alamat</b> <a class="float-right"><?php echo $d['karyawan_alamat'] ?></a>
                </li>                              
              </ul>
            </div>
            <!-- /.card-body -->
