									...
									<tr>
										...
										<td>
											...
											if($d['admin_foto']==""){
												?>
												<img
												src="../dist/img/" class="img-thumbnail" alt="Cinque Terre" width="60px" height="40px"> 
												<?php 
											}else{ 
												?> 
												<img src="../gambar/user/<?php echo $d['admin_foto'] ?>" class="img-thumbnail" alt="Cinque Terre" width="200" height="100">
												<?php 
											} 
											?>
										</td>
